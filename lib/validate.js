...
function validate( opts, options ) {
	...
	if ( hasOwnProp( options, 'borderTop' ) ) {
		...
		if ( !isString( options.borderTop ) ) {
			return new TypeError( format( 'invalid option. `%s` option must be a string primitive. Option: `%s`.', 'borderTop', options.borderTop ) );
		}
	}
	if ( hasOwnProp( options, 'borderBottom' ) ) {
		opts.borderBottom = options.borderBottom;
		if ( !isString( options.borderBottom ) ) {
			return new TypeError( format( 'invalid option. `%s` option must be a string primitive. Option: `%s`.', 'borderBottom', options.borderBottom ) );
		}
	}
	if ( hasOwnProp( options, 'borderLeft' ) ) {
		opts.borderLeft = options.borderLeft;
		if ( !isString( options.borderLeft ) ) {
			return new TypeError( format( 'invalid option. `%s` option must be a string primitive. Option: `%s`.', 'borderLeft', options.borderLeft ) );
		}
	}
	if ( hasOwnProp( options, 'borderRight' ) ) {
		opts.borderRight = options.borderRight;
		if ( !isString( options.borderRight ) ) {
			return new TypeError( format( 'invalid option. `%s` option must be a string primitive. Option: `%s`.', 'borderRight', options.borderRight ) );
		}
	}
	...
	if ( hasOwnProp( options, 'workspace' ) ) {
		...
		if ( !isString( options.workspace ) ) {
			return new TypeError( format( 'invalid option. `%s` option must be a string primitive. Option: `%s`.', 'workspace', options.workspace ) );
		}
	}
	if ( hasOwnProp( options, 'load' ) ) {
		opts.load = options.load;
		if ( !isString( options.load ) ) {
			return new TypeError( format( 'invalid option. `%s` option must be a string primitive. Option: `%s`.', 'load', options.load ) );
		}
	}
